...
import core.arpan.delivery.utils.networking.requests.LoginOTPRequest
import core.arpan.delivery.utils.networking.requests.RefreshRequest
import core.arpan.delivery.utils.networking.requests.SendOTPRequest
...
@Inject constructor(
  ...
  suspend fun getLoginResponse(phone: String, otp: String) =
    retrofitBuilder.apiService.login(LoginOTPRequest(phone, otp))

  suspend fun getSendOTPResponse(phone: String, signature: String) =
    retrofitBuilder.apiService.sendOTP(SendOTPRequest(phone, signature))
